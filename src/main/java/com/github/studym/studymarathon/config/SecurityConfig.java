...
import com.github.studym.studymarathon.config.handler.MemberLoginSuccessHandler;
...
/*        http.authorizeRequests().antMatchers("/api/title").permitAll();
    ...
    public ApiLoginFilter apiLoginFilter() throws Exception {
        ...
        apiLoginFilter.setAuthenticationManager(authentication -> authentication);
    ...
    public ApiCheckFilter apiCheckFilter() {
        return new ApiCheckFilter("/api/member/*");
    }
}
